...
class ChangelogPage(PaginatedResponse):
...
class Votes(JiraModel):
    self_url: str | None = Field(None, alias="self")
    votes: int | None = None
    has_voted: bool | None = Field(None, alias="hasVoted")
    voters: list[User] | None = None


class Watchers(JiraModel):
    self_url: str | None = Field(None, alias="self")
    watch_count: int | None = Field(None, alias="watchCount")
    is_watching: bool | None = Field(None, alias="isWatching")
...
class Worklog(JiraModel):
    ...
    comment: Any | None = None  # ADF document in v3
    created: datetime | None = None
    updated: datetime | None = None
...
class WorklogPage(PaginatedResponse):
    worklogs: list[Worklog] = Field(default_factory=list)


class RemoteIssueLinkIcon(JiraModel):
    url16x16: str | None = None
    title: str | None = None
    link: str | None = None


class RemoteIssueLinkObject(JiraModel):
    url: str | None = None
    title: str | None = None
    summary: str | None = None
    icon: RemoteIssueLinkIcon | None = None
    status: Any | None = None


class RemoteIssueLinkApplication(JiraModel):
    type: str | None = None
    name: str | None = None
...
class RemoteIssueLink(JiraModel):
    ...
    application: RemoteIssueLinkApplication | None = None
    relationship: str | None = None
    object: RemoteIssueLinkObject | None = None


class PropertyKey(JiraModel):
    self_url: str | None = Field(None, alias="self")
    key: str | None = None
